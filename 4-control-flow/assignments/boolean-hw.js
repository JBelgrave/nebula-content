...
// 7a Without changing any of the numbers, or their order. How do we make this print true?
// By changing the "&&" to "||"
console.log(10 > 2 || 3 > 4);
...
let hunger = 2
let hungerCheck = hunger > 6 ? "Time to eat!" : "I'm not hungry"
console.log(hungerCheck);
...
let answer = Math.ceil(Math.random()*5);
    switch (answer){
        ...
        case 4:
            ...
            break;
        default:
            console.log(`${question} Perchance.`);
}
